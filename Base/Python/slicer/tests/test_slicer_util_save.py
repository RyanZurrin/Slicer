...
class SlicerUtilSaveTests(unittest.TestCase):
    def setUp(self):
        for extension in ["nrrd", "mrml", "mrb"]:
            try:
                os.remove(f"{slicer.app.temporaryPath}/SlicerUtilSaveTests.{extension}")
            except OSError:
                pass
        shutil.rmtree(f"{slicer.app.temporaryPath}/SlicerUtilSaveTests", True)
    ...
    def test_saveNode(self):
        ...
        # Save
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTests.nrrd"
        ...
        # Save
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTestsSegmentation.nrrd"
        ...
        # Save
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTestsMarkup.json"
        ...
        # Save
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTestsText.txt"
        ...
        # Save
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTestsColor.txt"
        ...
        # Save
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTestsVolumeSequence.nrrd"
        ...
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTestsTerminology.json"
    ...
    def test_saveSceneAsMRMLFile(self):
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTests.mrml"
        self.assertTrue(slicer.util.saveScene(filename))
        self.assertTrue(os.path.exists(filename))

    def test_saveSceneAsMRB(self):
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTests.mrb"
        self.assertTrue(slicer.util.saveScene(filename))
        self.assertTrue(os.path.exists(filename))
    ...
    def test_saveSceneAsDirectory(self):
        ...
        """
        filename = f"{slicer.app.temporaryPath}/SlicerUtilSaveTests"
        self.assertTrue(slicer.util.saveScene(filename))
        self.assertTrue(os.path.exists(filename))
        self.assertTrue(os.path.exists(f"{filename}/SlicerUtilSaveTests.mrml"))
        self.assertTrue(os.path.exists(f"{filename}/Data/SlicerUtilSaveTests.nrrd"))
